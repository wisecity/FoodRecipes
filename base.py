...
class Recipe(db.Model):
	...
	Uid = db.Column(db.Integer, db.ForeignKey('USER.Id'), nullable=False, default=0)

	def __init__(self, Name, Contents, Details, PostTime=None, Views=None, Score=None, Uid=None):
		self.Name = Name
